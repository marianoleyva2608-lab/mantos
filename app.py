...
def init_db():
    ...
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Contactor AC CHINT NXC-32 220V 50/60Hz','Contactor','ALTA','Electrico / Control',3,3,'1–2 días','ELMESI / COINSA','Estante: CONTACTORES',480.0,'Stock OK ✓','CHINT NXC-32','926213')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Relevador térmico CHINT NR2-3E 2.8–4A','Relevador','ALTA','Electrico / Control',2,1,'1–2 días','ELMESI','Estante: CONTACTORES',320.0,'','CHINT NR2-3E','209106')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('SSR Fotek SSR-25VA 25A','SSR','ALTA','Electrico / Control',2,1,'3–5 días','COINSA','Estante: HERRAMIENTA',850.0,'','Fotek SSR-25VA','')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('SSR JMP 80A 480VAC','SSR','ALTA','Electrico / Control',1,1,'3–5 días','JMP / COINSA','Estante: HERRAMIENTA',1800.0,'Equipos grandes','JMP JG-34F D-480A50ZS-L','')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Timer Autonics AT8N 100–240VAC','Timer','MEDIA','Electrico / Control',3,4,'3–5 días','COINSA / Autonics','Estante: TIMER',650.0,'Stock abundante ✓','Autonics AT8N','')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Controlador temperatura Autonics TCN4S-24R','Control temp.','ALTA','Electrico / Control',2,3,'3–5 días','COINSA / Autonics','Estante: TIMER',1200.0,'Multi-sensor, Relay+SSR','Autonics TCN4S-24R','')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Relevador enchufable 8-pin 10A 250VAC','Relevador','MEDIA','Electrico / Control',6,6,'1–2 días','ELMESI / COINSA','Estante: ELECTRO VÁLVULAS',180.0,'Varios ✓','Finder','Omron')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Fuente 24VDC Moeller easy400-POW','Fuente DC','ALTA','Electrico / Control',1,1,'5–7 días','ELMESI','Estante: HERRAMIENTA',2200.0,'','Moeller easy400-POW','')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Switch de límite 15A 125–480V','Fin de carrera','MEDIA','Electrico / Control',4,3,'2–3 días','JMP / COINSA','Estante: HERRAMIENTA',380.0,'3 uds ✓','JMP Modelo 116-203','')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Fusibles surtidos (caja)','Fusible','ALTA','Electrico / Control',1,1,'1 día','ELMESI','Estante: HERRAMIENTA',300.0,'Caja ✓','Hanyoung NUX','varios')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Bloque terminal 5T (JMP)','Terminal','BAJA','Electrico / Control',10,10,'1 día','JMP / COINSA','Estante: CONTACTORES',25.0,'','JMP 5T','')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Kit terminales aisladas 55 pz 12–22 AWG','Terminal','BAJA','Electrico / Control',2,2,'1 día','Tuk / Office Depot','Estante: CONTACTORES',85.0,'','Voltec','Tuk')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Resistencia tubular tipo U #BN-1 (horquilla)','Resistencia','ALTA','Resistencias / Calefaccion',5,20,'5–10 días','TCR','Estante: RESISTENCIAS',380.0,'Caja ~20 pzas ✓','TCR','SAL00002')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Resistencia plana 220/230VAC 650W termocupla K 25×6.5cm','Resistencia','ALTA','Resistencias / Calefaccion',2,2,'5–10 días','TCR','Estante: RESISTENCIAS',650.0,'','TCR SAL00002','')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Resistencia plana 220/230VAC 625W termopar K 25×65cm','Resistencia','ALTA','Resistencias / Calefaccion',2,2,'5–10 días','TCR','Estante: RESISTENCIAS',620.0,'','TCR SAL00002 NEGU','')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Resistencia plana 220/230VAC 325W termocupla K 12×6.5cm','Resistencia','ALTA','Resistencias / Calefaccion',4,7,'5–10 días','TCR','Estante: RESISTENCIAS',380.0,'~7 pzas ✓','TCR','')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Resistencia plana 220/230VAC 300W termocupla K 12×6.5cm','Resistencia','ALTA','Resistencias / Calefaccion',2,1,'5–10 días','TCR','Estante: RESISTENCIAS',350.0,'','TCR','')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Terminal de cerámica para resistencia','Consumible','MEDIA','Resistencias / Calefaccion',10,10,'3–5 días','TCR / COINSA','Estante: TERM. CERÁMICA',45.0,'','Genérico','')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Termopar tipo K de repuesto','Sensor','ALTA','Resistencias / Calefaccion',4,2,'3–5 días','COINSA / Autonics','Estante: ITM TEMP.',280.0,'','Genérico','Autonics')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Válvula solenoide DE WIT 2W-25-NC-E-VI5 1" NC','Electroválvula','ALTA','Neumatico / Hidraulico',2,2,'3–5 días','DE WIT / COINSA','Estante: ELECTRO VÁLVULAS',950.0,'NC ✓','DE WIT 2W-25-NC-E-VI5','')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Electroválvula neumática 4/2 vías 24VDC','Electroválvula','ALTA','Neumatico / Hidraulico',2,1,'3–5 días','SMC / COINSA','Estante: ELECTRO VÁLVULAS',780.0,'','Sportronic','SMC')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Manómetro glicerina 0–10 bar 1/4"','Instrumento','BAJA','Neumatico / Hidraulico',2,2,'2–3 días','COINSA','Estante: MANOMETROS',220.0,'✓','Wika','Varios')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Condensador de marcha motor 110V 50/60Hz','Capacitor','MEDIA','Neumatico / Hidraulico',3,3,'2–3 días','COINSA / Grainger','Estante: ELECTRO VÁLVULAS',180.0,'✓','Genérico','')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Rodamiento / balero URB RUM','Rodamiento','MEDIA','Neumatico / Hidraulico',2,1,'3–5 días','Distribuidora SKF','Estante: RODAMIENTOS',250.0,'Verificar # antes de pedir','URB RUM','')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Fitting neumático push-to-connect surtido','Fitting','BAJA','Neumatico / Hidraulico',10,10,'1–2 días','SMC / COINSA','Estante: ELECTRO VÁLVULAS',45.0,'✓','SMC','Parker')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Manguera aire tejida blanca (spool)','Manguera','BAJA','Neumatico / Hidraulico',1,1,'3–5 días','COINSA / SMC','Bodega / piso',1800.0,'Rollo ✓','Genérico','')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Soldadura estaño 60/40 1mm 450g','Consumible','BAJA','Consumibles / Insumos',2,2,'1 día','Truper / ferretería','Estante: HERRAMIENTA',180.0,'Varios rollos ✓','Truper 60','40')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Cinta aislante PVC amarilla','Consumible','BAJA','Consumibles / Insumos',4,3,'1 día','Office Depot','Estante: CONTACTORES',35.0,'','Voltec','3M')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Cinta fibra de vidrio alta temp.','Consumible','MEDIA','Consumibles / Insumos',2,1,'3–5 días','COINSA','Estante: RESISTENCIAS',120.0,'Para resistencias','Genérico','')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Cinta teflón 1/2"','Consumible','BAJA','Consumibles / Insumos',5,3,'1 día','Ferretería','Estante: HERRAMIENTA',18.0,'','Genérico','')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Pegamento instantáneo super glue','Consumible','BAJA','Consumibles / Insumos',2,2,'1 día','Ferretería','Estante: CONTACTORES',45.0,'✓','Loctite','Genérico')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Lubricante anti-agarrotamiento LB 771','Lubricante','BAJA','Consumibles / Insumos',1,1,'5–7 días','Grainger','Estante: RESISTENCIAS',380.0,'Lata ✓','LB 771','Jet-Lube')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Aceite refrigerante Würth 500ml spray','Lubricante','BAJA','Consumibles / Insumos',2,1,'3–5 días','Würth MX','Estante: RODAMIENTOS',280.0,'','Würth 520','')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Compuesto térmico Arctic','Consumible','BAJA','Consumibles / Insumos',1,1,'3–5 días','Amazon','Estante: HERRAMIENTA',150.0,'','Arctic','')")
    con.execute("INSERT OR IGNORE INTO refacciones (nombre,categoria,criticidad,seccion,cant_min,stock_actual,tiempo_entrega,proveedor,ubicacion,costo,notas,marca,modelo) VALUES ('Cable conductor Viakon / Condumex (rollo)','Cable','MEDIA','Consumibles / Insumos',1,1,'3–5 días','Viakon / ELMESI','Estante: RESISTENCIAS',1200.0,'Cal. según aplicación','Viakon','Condumex')")
    con.commit()  # seed
